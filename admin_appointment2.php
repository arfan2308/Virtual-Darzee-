...
if(isset($_GET['delete'])){
   ...
   mysqli_query($conn, "DELETE FROM appointment2 WHERE id = '$delete_id'") or die('query failed');
   header('location:admin_appointment2.php');
}
...
<section class="messages">
   ...
   <?php
      $select_message = mysqli_query($conn, "SELECT * FROM appointment2") or die('query failed');
   ...
   <div class="box">
      ...
      <a href="admin_appointment2.php?delete=<?php echo $fetch_message['id']; ?>" onclick="return confirm('delete this message?');" class="delete-btn">delete message</a>
   </div>
   <?php
      };
   }else{
