...
if(isset($_POST["submitbtn"])){
    ...
    $backshoulder= $_POST["backshoulder"];
    $underbusttowaist= $_POST["underbusttowaist"];
    $waisttohip= $_POST["waisttohip"];
    $waist= $_POST["waist"];
    $hips= $_POST["hips"];
    $length= $_POST["length"];
    ...
    $title= $_POST["title"];
        ...
        $query = "INSERT into measurement2 VALUES('', '$fullname','$custid','$type','$address','$date','$phnumber','$neck','$chest','$stomach','$backshoulder','$underbusttowaist','$waisttohip','$waist','$hips','$length','$sleevelength','$wrist','$crotch','$thighwidth','$pantlength','$inseam','$kneelength','$title','$pname')";
        ...
        <div class="main-form">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <input type="nummber" name="custid" id="name" placeholder="Customer Id" required> 
                </div>
                <div>
                    ...
                    <select name="type" id="type">
                       <option value="">---select appointment type---</option>
                        ...
                        <option value="Custom Men Design">Custom Men Design</option>
                        <option value="Designer Boutique For Women">Designer Boutique For Women</option>
                        <option value="Corporate Dress Designer">Corporate Dress Designer</option>
                        <option value="Wedding Dress Designers">Wedding Dress Designers</option>
                        <option value="Custom Embroidery Work">Custom Embroidery Work</option>
                        <option value="Alteration & Repair Service At Doorstep">Alteration & Repair Service At Doorstep</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="text" name="address" id="time" placeholder="address*" required>
                </div>
                <div>
                    <span>Date</span>
                ...
                <div>
                    ...
                    <input type="text" name="phnumber" id="number" placeholder="Number*" required>
                </div>
                <h1><span>Measurement For Women</span></h1>
                <div>
                    <span>Neck</span>
                ...
                <div>
                    <span>Back Shoulder Width</span>
                    <input type="number" name="backshoulder" id="stomach" required>
                </div>
                <div>
                    <span>Underbust to Waist</span>
                    <input type="number" name="underbust" id="stomach" required>
                </div>
                <div>
                    <span>Waist to Hips</span>
                    <input type="number" name="waisttohip" id="stomach" required>
                </div>
