...
<section class="messages">
   ...
   <h1 class="title"> Appointments For Home Visit</h1>

   <div class="box-container">
   <?php
      $select_message = mysqli_query($conn, "SELECT * FROM appointment1") or die('query failed');
   ...
   <div class="box">
      ...
      <a href="admin_appointment1.php?delete=<?php echo $fetch_message['id']; ?>" onclick="return confirm('delete this message?');" class="delete-btn">delete message</a>
   </div>
   <?php
      };
   }else{
