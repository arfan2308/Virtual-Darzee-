...
if(!empty($_SESSION["id"])){
  $id = $_SESSION["id"];
  $result = mysqli_query($conn, "SELECT * FROM appointment2 WHERE id = $id");
...
if(isset($_POST["submitbtn"])){
    ...
    $emailcount = mysqli_num_rows($query);
        ...
        $uploads_dir = 'C:\Users\Shaikh Arfan\Downloads\project\Appointment images\women dress';
        ...
        if($emailcount>0)
        {
            $query1 = "INSERT into appointment2 VALUES('', '$fullname','$Email','$time','$address','$date',$phnumber,'$title','$pname')";
...
<img src="images/logon.png" alt="">
    <div class="form">
        <div class="form-text">
            <h1><span>Book an Appointment For Women Dress</span></h1>
