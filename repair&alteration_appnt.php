...
if(!empty($_SESSION["id"])){
  $id = $_SESSION["id"];
  $result = mysqli_query($conn, "SELECT * FROM repairalteration WHERE id = $id");
...
if(isset($_POST["submitbtn"])){
    ...
    $emailcount = mysqli_num_rows($query);
        ...
        $uploads_dir = 'C:\Users\Shaikh Arfan\Downloads\project\Appointment images\repair&alteraion img';
        ...
        if($emailcount>0)
        {
            $query1 = "INSERT into repairalteration VALUES('', '$fullname','$Email','$time','$address','$date',$phnumber,'$title','$pname')";
...
<img src="images/logon.png" alt="">
    <div class="form">
        <div class="form-text">
            <h1><span>Book an Appointment For Repair & Alteration</span></h1>
